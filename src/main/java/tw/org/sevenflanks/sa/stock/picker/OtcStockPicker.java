...
public class OtcStockPicker {
	...
	public OtcStockModel getStockDay(LocalDate date) {
		...
		// 建立request
		final UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl("https://www.tpex.org.tw/web/stock/aftertrading/daily_close_quotes/stk_quote_result.php")
				.queryParam("l", "zh-tw")
				.queryParam("o", "json")
