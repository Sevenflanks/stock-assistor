...
@Entity
@Table(indexes = {
		@Index(name = "OTCRGREMAIN_IDX1", columnList = "syncDate"),
		@Index(name = "OTCRGREMAIN_IDX2", columnList = "uid")
})
public class OtcRgremain extends SyncDateEntity {
	...
	public OtcRgremain(OtcExchangeDetailModel model) {
